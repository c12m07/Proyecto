package generica.T_Productos.Model;

import org.springframework.data.annotation.Id;
import org.springframework.data.mongodb.core.mapping.Document;

@Document(collection = "productos_medellin")
public class Med_Mod_Productos {
	...
	public Med_Mod_Productos() {}

	public Med_Mod_Productos(String id, String nombre_producto, Integer nitproveedor, Integer precio_compra,
	...
	public String toString() {
		return "Med_Mod_Productos [id=" + id + ", nombre_producto=" + nombre_producto + ", nitproveedor=" + nitproveedor
				+ ", precio_compra=" + precio_compra + ", ivacompra=" + ivacompra + ", precio_venta=" + precio_venta
				+ "]";
	}
