...
@Document(collection = "productos_cali")
public class Cal_Mod_Productos {
	...
	public Cal_Mod_Productos() {}

	public Cal_Mod_Productos(String id, String nombre_producto, Integer nitproveedor, Integer precio_compra,
	...
	public String toString() {
		return "Cal_Mod_Productos [id=" + id + ", nombre_producto=" + nombre_producto + ", nitproveedor=" + nitproveedor
