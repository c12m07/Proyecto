...
@Document(collection = "proveedores_medellin")
public class Med_Mod_Proveedores {
	...
	public Med_Mod_Proveedores() {}

	public Med_Mod_Proveedores(String id, String ciudad_proveedor, String direecion_proveedor, String nombre_proveedor,
	...
	public String toString() {
		return "Med_Mod_Proveedores [id=" + id + ", ciudad_proveedor=" + ciudad_proveedor + ", direecion_proveedor="
