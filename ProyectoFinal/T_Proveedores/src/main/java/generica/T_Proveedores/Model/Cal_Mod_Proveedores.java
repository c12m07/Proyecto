...
@Document(collection = "proveedores_cali")
public class Cal_Mod_Proveedores {
	...
	public Cal_Mod_Proveedores() {}

	public Cal_Mod_Proveedores(String id, String ciudad_proveedor, String direecion_proveedor, String nombre_proveedor,
	...
	public String toString() {
		return "Cal_Mod_Proveedores [id=" + id + ", ciudad_proveedor=" + ciudad_proveedor + ", direecion_proveedor="
